    ...
    <header id="main-header">
        <div class="container header-inner">
            ...
            <div class="nav-actions">
                ...
                ${user ? `
                    <a class="nav-icon-btn" data-link="/account" title="Mi Cuenta" style="color:var(--accent);">
                    ...
                    <a data-link="/account" style="font-size:0.85rem;color:var(--text-primary);font-weight:700;cursor:pointer;">${user.name.split(" ")[0]}</a>
